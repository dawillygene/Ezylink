<x-app>
    <div class="p-6 space-y-6">
        ...
        <div class="flex w-full items-center justify-between print:hidden">
            <h4 class="text-lg font-semibold text-default-900">Shop Details</h4>
            ...
            <div class="2xl:sticky top-20 2xl:col-span-1">
                <div class="space-y-6">
                    <div class="px-2 md:pt-2 pt-0 rounded-lg border border-default-200 mb-6">
                        <img src="assets/banner-2-6706dc01.png" class="h-40 w-full md:flex hidden rounded-lg">

                        <div class="p-5">
                            <div class="-mt-16 relative max-md:mt-0">
                                <div class="h-20 w-20 rounded-full bg-default-200 p-1 mb-2 max-md:hidden">
                                    <img src="assets/1-1bb67308.png" alt=""
                                        class="max-w-full h-full rounded-full">
                                </div>
                                <div class="flex justify-between gap-6">
                                    <div class="">
                                        <h6 class="text-lg font-semibold text-default-950 mb-0.5">
                                            {{ $shopDetail->company_name }}</h6>
                                        <p class="text-sm text-default-600">Since 2013</p>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <a type="button" href="{{ route('ShopDetails.edit', $shopDetail->id) }}"
                                            class="py-2 px-4 inline-flex items-center justify-center text-xs font-medium rounded bg-default-200 transition-all duration-300 hover:bg-default-300 text-default-900"><i
                                                class="ti ti-edit-circle text-sm/none me-1"></i> Edit</a>
                                        <button type="button"
                                            class="py-2 px-4 inline-flex items-center justify-center text-xs font-medium rounded bg-red-500 text-white transition-all duration-300 hover:bg-red-600"><i
                                                class="ti ti-trash text-sm/none me-1"></i> Delete</button>
                                    </div>
                                </div>
                    ...
                    <div class="rounded-lg border border-default-200 mb-6">
                        ...
                        <div class="p-5 border-t border-dashed border-default-200">
                            <p class="text-default-600 mb-3"><strong>Owner Name: :</strong> <span
                                    class="ms-2">{{ $shopDetail->first_name }} {{ $shopDetail->last_name }}</span></p>

                            <p class="text-default-600 mb-3"><strong>Company Type: :</strong> <span
                                    class="ms-2">LLP</span></p>

                            <p class="text-default-600 mb-3"><strong>Email :</strong><span
                                    class="ms-2">{{ $shopDetail->email }}</span></p>

                            <p class="text-default-600 mb-3"><strong>Contact No :</strong> <span
                                    class="ms-2 ">{{ $shopDetail->contact_number }}</span></p>

                            <p class="text-default-600 mb-3"><strong>Fax :</strong> <span
                                    class="ms-2 ">{{ $shopDetail->fax_number }}</span></p>

                            <p class="text-default-600"><strong>Location :</strong> <span
                                    class="ms-2">{{ $shopDetail->country }},{{ $shopDetail->city }}</span></p>
                        </div>
                    </div>
                        ...
                        <div class="p-5 border-t border-dashed border-default-200">
                            ...
                            <div class="flex justify-around mb-6">
                                <div class="text-center">
                                    <h2 class="text-2xl font-medium text-default-900 mb-1">4.5 <i
                                            class="ti ti-star-filled inline-flex align-middle text-lg text-yellow-400"></i>
                                    </h2>
                            ...
                            <div class="mb-4">
                                <div class="flex gap-3 items-center mb-4">
                                    <img src="assets/1-f1564e7c.png" class="w-11 h-11 rounded-full">
                                    <div class="flex-grow">
                                        <h4 class="text-sm font-medium text-default-700 mb-1">Kianna Stanton <span
                                                class="text-default-600">🇺🇸US</span></h4>
                                ...
                                <p class="text-sm text-default-600">Lorem ipsum dolor sit amet, consectetur adipiscing
                            ...
                            <div class="mb-4">
                                <div class="flex gap-3 items-center mb-4">
                                    <img src="assets/2-cb0540ba.png" class="w-11 h-11 rounded-full">
                                    <div class="flex-grow">
                                        <h4 class="text-sm font-medium text-default-700 mb-1">Ryan Rhiel Madsen <span
                                                class="text-default-600">🇺🇸US</span></h4>
                                        <h4 class="text-xs text-green-400">Verified Buyer</h4>
                                    </div>
                                    <div>
                    ...
                    <div class="rounded-lg border border-default-200">
                        ...
                        <div class="p-5 border-t border-dashed border-default-200">
                            <textarea
                                class="form-input bg-transparent rounded w-full border border-default-200 mb-4 focus:border-primary focus:ring-0"
                                placeholder="Message" rows="4"></textarea>

                            <div class="text-end">
                                <button
                                    class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-sm text-center bg-primary hover:bg-primary-600 border-primary hover:border-primary-600 text-white rounded-md">Send
                                    Message <i class="ti ti-send"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <table class="min-w-full divide-y divide-default-200">
                                                <thead class="bg-default-100/75">
                                                    <tr>
                                                        ...
                                                        <th scope="col"
                                                            class="px-6 py-3 text-start text-sm capitalize font-semibold text-default-900">
                                                            Products</th>
                                                        <th scope="col"
                                                            class="px-6 py-3 text-start text-sm capitalize font-semibold text-default-900">
                                                            Category</th>
                                                        ...
                                                        <th scope="col"
                                                            ...
                                                            Score Status</th>
                                                        <th scope="col"
                                                            class="px-6 py-3 text-center text-sm capitalize font-semibold text-default-900">
                                                            Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="divide-y divide-default-200">
                                                    <tr>
                                                        ...
                                                        <td
                                                            class="px-6 py-4 whitespace-nowrap text-base text-default-800">
                                                            Fruit</td>
                                                        <td
                                                            class="px-6 py-4 whitespace-nowrap text-base text-default-800">
                                                            $14.99</td>
                                                        ...
                                                        <td
                                                            ...
                                                            Average</td>
                                                        <td
                                                            class="whitespace-nowrap py-3 px-3 text-center text-sm font-medium">

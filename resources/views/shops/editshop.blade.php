...
@section('content')
    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex w-full items-center justify-between print:hidden">
            <h4 class="text-lg font-semibold text-default-900">Edit Shops</h4>
        ...
        <div class="rounded-lg border border-default-200 bg-white dark:bg-default-50 overflow-hidden">
            <div class="px-6 py-4">
                <nav class="flex flex-wrap items-center gap-4" aria-label="Tabs" role="tablist">
                    <button type="button"
                        class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-20 inline-flex items-center bg-primary/10 text-sm font-medium text-center text-primary rounded-lg active"
                        data-hs-tab="#tabBusinessDetail" aria-controls="tabBusinessDetail" role="tab">
                        <i class="ti ti-heart-handshake text-lg me-1"></i>
                        Business Detail
                    </button>
                    <button type="button"
                        class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-20 inline-flex items-center bg-primary/10 text-sm font-medium text-center text-primary rounded-lg"
            ...
            <div class="p-5 border-t border-dashed border-default-200">
                ...
                <form id="addShopForm" action="{{ route('ShopDetails.update', $shopDetail->id ) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div id="tabBusinessDetail" role="tabpanel" class="">
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="firstName">First
                                    Name</label>
                                <input id="firstName" name="first_name" value="{{ $shopDetail->first_name }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="lastName">Last
                                    Name</label>
                                <input id="lastName" name="last_name" value="{{ $shopDetail->last_name }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="contactNumber">Contact
                                    Number</label>
                                <input id="contactNumber" name="contact_number" value="{{ $shopDetail->contact_number }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="phoneNumber">Phone
                                    Number</label>
                                <input id="phoneNumber" name="phone_number" value="{{ $shopDetail->phone_number }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="emailAddress" name="email" value="{{ $shopDetail->email }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="birthofDate">Birth of
                                    Date</label>
                                <input id="birthofDate" name="birth_of_date" value="{{ $shopDetail->birth_of_date }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                        ...
                        <div class="grid lg:grid-cols-3 gap-6 mb-6">
                            <div>
                                ...
                                <input id="city" name="city" value="{{ $shopDetail->city }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="country" name="country" value="{{ $shopDetail->country }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="zipCode">ZIP
                                    code</label>
                                <input id="zipCode" name="zip_code" value="{{ $shopDetail->zip_code }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div class="lg:col-span-3">
                                ...
                                <textarea id="description" name="description" value="{{ $shopDetail->description }}"
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="companyName">Company
                                    Name</label>
                                <input id="companyName" name="company_name" value="{{ $shopDetail->company_name }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="companyType">Company
                                    Type</label>
                                <input id="companyType" name="company_type" value="{{ $shopDetail->company_type }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="panCardNumber" name="pan_card_number"
                                    value="{{ $shopDetail->pan_card_number }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="faxNumber">Fax
                                    Number</label>
                                <input id="faxNumber" name="fax_number" value="{{ $shopDetail->fax_number }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="website" name="website" value="{{ $shopDetail->website }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="email" name="email" value="{{ $shopDetail->email }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="companyNumber" name="number" value="{{ $shopDetail->number }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                        ...
                        <div class="grid lg:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="bankName">Bank
                                    Name</label>
                                <input id="bankName" name="bank_name" value="{{ $shopDetail->bank_name }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                ...
                                <input id="bankBranch" name="branch" value="{{ $shopDetail->branch }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input id="accountHolderName" name="account_holder_name"
                                    value="{{ $shopDetail->account_holder_name }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="accountNumber">Account
                                    Number</label>
                                <input id="accountNumber" name="account_number" value="{{ $shopDetail->account_number }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-default-900 mb-2" for="IFSCCode">IFSC
                                    Code</label>
                                <input id="IFSCCode" name="ifsc_code" value="{{ $shopDetail->ifsc_code }}"
                                    class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50"
